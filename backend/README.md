...
## Project Structure
    ...
    ├── custom_gaming_compu_42972  # Django project configurations
...
1. Clone this repo and `cd custom_gaming_compu_42972`
...
2. Clone this repo and `cd custom_gaming_compu_42972`
